...
public class Create2 extends Activity {
 ...
 //   EditText t1;
   ...
   //     t1=(EditText)findViewById(R.id.accid);
...

        {
            ...
            db.execSQL("CREATE TABLE unittwo (qno integer PRIMARY KEY AUTO INCREMENT, ques text,marks integer)");
...
//                values.put("qno",s);
                ...
                if((db.insert("unittwo",null,values))!= -1)

                {

                    Toast.makeText(Create2.this, "Inserted...", 2000).show();
...

                {
                    ...
                    Toast.makeText(Create2.this,"Error...",2000).show();
