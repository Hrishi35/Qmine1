...
public class Create4 extends Activity {
...
//    EditText t1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
...

        {
            ...
            db.execSQL("CREATE TABLE unitfour (qno integer PRIMARY KEY AUTO INCREMENT, ques text,marks integer)");
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((db.insert("unitfour",null,values))!= -1)

                {

                    Toast.makeText(Create4.this, "Inserted...", 2000).show();
...

                {
                    ...
                    Toast.makeText(Create4.this,"Error...",2000).show();
