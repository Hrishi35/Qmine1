...
public class Create5 extends Activity {
...
//    EditText t1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
...

        {
            ...
            db.execSQL("CREATE TABLE unitfive (qno integer PRIMARY KEY AUTO INCREMENT, ques text,marks integer)");
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // values.put("qno",s);
                ...
                if((db.insert("unitfive",null,values))!= -1)

                {

                    Toast.makeText(Create5.this, "Inserted...", 2000).show();
...

                {
                    ...
                    Toast.makeText(Create5.this,"Error...",2000).show();
