...
public class create3 extends Activity {
...
//    EditText t1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
...

        {
            ...
            db.execSQL("CREATE TABLE unitthree (qno integer PRIMARY KEY AUTO INCREMENT, ques text,marks integer)");
...
//                values.put("qno",s);
                ...
                if((db.insert("unitthree",null,values))!= -1)

                {

                    Toast.makeText(create3.this, "Inserted...", 2000).show();
...

                {
                    ...
                    Toast.makeText(create3.this,"Error...",2000).show();
